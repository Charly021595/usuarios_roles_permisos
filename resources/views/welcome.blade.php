...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 barra_superior_horizontal">
    ...
    <a href="{{ route('home') }}" class="brand-link" style="text-align:center; background:#fff;">
      <h1 style="color: black;">Prueba</h1>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block" style="font-size: 13px;">Prueba</a>
        </div>
      </div>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="oufits.php">Inicio</a></li>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
              <div class="card-header bg-success">Creación de Usuarios</div>
              <div class="card-body">
...
<!-- ./wrapper -->
<script src="{{ asset('js/traer_users.js') }}?t=<?=time()?>"></script>
</body>
</html>